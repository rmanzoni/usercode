...
track_histos = {}
names  = ['offTrk_failDMonl_hasOnlTrk_mu','onlTrk_failDMonl_hasOnlTrk_mu','offTrk_failDMonl_noOnlTrk_mu' ,'offTrk_failDMonl_hasOnlTrk_pix','onlTrk_failDMonl_hasOnlTrk_pix','offTrk_failDMonl_noOnlTrk_pix']
...
myAnalyzer = PATreader.PATreader(myFiles, basic_histos=basic_histos, track_histos=track_histos)
