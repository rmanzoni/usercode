...
## switch off boosted tau improvements
process.ak5PFJetsRecoTauChargedHadrons.builders[0] = cms.PSet(
    minMergeChargedHadronPt = cms.double(1.e+6),
    name = cms.string('chargedPFCandidates'),
    dRmergeNeutralHadronWrtOther = cms.double(-1.0),
    plugin = cms.string('PFRecoTauChargedHadronFromPFCandidatePlugin'),
    minBlockElementMatchesPhoton = cms.int32(1000),
    dRmergeNeutralHadronWrtNeutralHadron = cms.double(-1.0),
    ...
    dRmergeNeutralHadronWrtElectron = cms.double(-1.0),
    minBlockElementMatchesNeutralHadron = cms.int32(1000),
    dRmergePhotonWrtOther = cms.double(-1.0),
    chargedHadronCandidatesParticleIds = cms.vint32(1, 2, 3),
    minMergeNeutralHadronEt = cms.double(1.e+6),
    minMergeGammaEt = cms.double(1.e+6),
    dRmergeNeutralHadronWrtChargedHadron = cms.double(-1.0),
    dRmergePhotonWrtChargedHadron = cms.double(-1.0),
    dRmergePhotonWrtNeutralHadron = cms.double(-1.0),
    maxUnmatchedBlockElementsNeutralHadron = cms.int32(1),
    dRmergePhotonWrtElectron = cms.double(-1.0)
    )
process.combinatoricRecoTaus.modifiers[2] = cms.PSet(
    dRaddPhoton = cms.double(-1.0),
    minNeutralHadronEt = cms.double(1.e+6),
    minGammaEt = cms.double(1.e+6),
    dRaddNeutralHadron = cms.double(-1.0),
    verbosity = cms.int32(0),
...
execfile("online-tau-rereco_v3.py")
process.HLT_IsoMu17_eta2p1_LooseIsoPFTau20_NoFilters_v7.replace(
