# /users/mbluj/CMSSW_5_2_8/SingleTau2013/V1 (CMSSW_5_2_8)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/mbluj/CMSSW_5_2_8/SingleTau2013/V1')
)
...
process.hltPreSingleLooseIsoPFTau20NoFilters = cms.EDFilter( "HLTPrescaler",
...
process.HLT_SingleLooseIsoPFTau20_NoFilters_v7 = cms.Path( process.HLTBeginSequence + process.hltPreSingleLooseIsoPFTau20NoFilters + process.HLTRecoJetSequencePrePF + process.HLTPFTriggerSequenceForTaus + process.HLTLoosePFTauSequenceStdVtx + process.HLTEndSequence )
...
if not isMC:
	execfile("pat-and-out_singleTau.py")
else:
	execfile("pat-and-out_singleTau_MC.py")
...
process.HLT_SingleLooseIsoPFTau20_NoFilters_v7.replace(
	process.HLTEndSequence,
	process.offlineSequence+process.uct2015Sequence+process.HLTEndSequence
)
process.patOut.SelectEvents.SelectEvents = ["HLT_SingleLooseIsoPFTau20_NoFilters_v7"]
...
process.HLT_SingleLooseIsoPFTau20_NoFilters_v7.replace(
    process.HLTLoosePFTauSequenceStdVtx,
    process.hltTauSequence
)
process.HLT_SingleLooseIsoPFTau20_NoFilters_v7.remove(process.makeHltPatTaus)
process.hltTauSequence.remove(process.hltPFTauSequnceNP)
process.hltTauSequence.remove(process.hltPatTausNP)
process.hltTauSequence.remove(process.selectedHltPatTausNP)
