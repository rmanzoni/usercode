...
process.hltPFlowTrackSelectionHighPurity = cms.EDProducer( "AnalyticalTrackSelector",
    ...
    keepAllTracks = cms.bool( False ), ## original
    #keepAllTracks = cms.bool( True ), ## for testing
...
process.hltAntiKT5TrackJetsIter0 = cms.EDProducer( "FastjetJetProducer",
    ...
    UseOnlyVertexTracks = cms.bool( False ),
    #UseOnlyOnePV = cms.bool( True ), ## RM original
    UseOnlyOnePV = cms.bool( False ), ## RM TEST
...
#     fractionMinCaloInTauCone       = cms.double( 0.0  ),                                 #cms.double( 0.7 ),                                 
#     fractionMaxChargedPUInCaloCone = cms.double( 2.0  ),                                 #cms.double( 0.3 ),                                 
#     tauConeSize                    = cms.double( 0.2  ),                                 #cms.double( 0.2 ),                                 
#     ptTrkMaxInCaloCone             = cms.double( 999. ),                                 #cms.double( 1.0 ),                                 
#     isolationConeSize              = cms.double( 0.5  ),                                 #cms.double( 0.5 ),                                 
#     inputTrackJetTag               = cms.InputTag( "hltAntiKT5TrackJetsIter0" ),         #cms.InputTag( "hltAntiKT5TrackJetsIter0" ),        
#     nTrkMaxInCaloCone              = cms.int32( 999 ),                                   #cms.int32( 0 ),                                    
#     inputCaloJetTag                = cms.InputTag( "hltAntiKT5CaloJetsPFEt5" ),          #cms.InputTag( "hltAntiKT5CaloJetsPFEt5" ),         
#     etaMinCaloJet                  = cms.double( -2.7 ),                                 #cms.double( -2.7 ),                                 
#     etaMaxCaloJet                  = cms.double( 2.7 ),                                  #cms.double( 2.7 ),                                 
#     ptMinCaloJet                   = cms.double( 5.0 ),                                  #cms.double( 5.0 ),                                 
#     inputTrackTag                  = cms.InputTag( "hltPFlowTrackSelectionHighPurity" )  #cms.InputTag( "hltPFlowTrackSelectionHighPurity" ) 
# )
#### RM: ORIGINAL
process.hltTrackAndTauJetsIter0 = cms.EDProducer( "TauJetSelectorForHLTTrackSeeding",
...
# process.hltPixelVerticesAfterIter0 = cms.EDProducer( "PixelVertexProducer",
#     WtAverage = cms.bool( True ),
#     Method2 = cms.bool( True ),
#     beamSpot = cms.InputTag( "hltOnlineBeamSpot" ),
#     Verbosity = cms.int32( 0 ),
#     UseError = cms.bool( True ),
#     TrackCollection = cms.InputTag( "hltPFlowTrackSelectionHighPurity" ),
...
process.hltOnlineVerticesAfterIter0 = cms.EDProducer( "PrimaryVertexProducer",
    ...
    beamSpotLabel = cms.InputTag( "hltOnlineBeamSpot" ),
    TrackLabel = cms.InputTag( "hltPFlowTrackSelectionHighPurity" ),
...
process.hltIter1PFJetPixelSeeds = cms.EDProducer( "SeedGeneratorFromRegionHitsEDProducer",
    RegionFactoryPSet = cms.PSet( 
      ...
      RegionPSet = cms.PSet( 
        ...
        vertexSrc = cms.InputTag( "hltOnlineVerticesAfterIter0" ),
...
process.hltIter1PFlowTrackSelectionHighPurityLoose = cms.EDProducer( "AnalyticalTrackSelector",
    ...
    chi2n_no1Dmod_par = cms.double( 9999.0 ),
    vertices = cms.InputTag( "hltOnlineVerticesAfterIter0" ),
    max_eta = cms.double( 9999.0 ),
...
process.hltAntiKT5TrackJetsIter1 = cms.EDProducer( "FastjetJetProducer",
    ...
    inputEtMin = cms.double( 0.1 ),
    puPtMin = cms.double( 0.0 ),
    srcPVs = cms.InputTag( "hltOnlineVerticesAfterIter0" ),
...
process.hltPFMuonMerging = cms.EDProducer( "SimpleTrackListMerger",
    ...
    allowFirstHitShare  = cms.bool( True ),
    newQuality          = cms.string( "confirmed" ),
    MaxNormalizedChisq  = cms.double( 1000000.0 ),
    TrackProducer1      = cms.string( "hltL3TkTracksFromL2" ),
...
process.hltParticleFlowForTaus = cms.EDProducer( "PFProducer",
    ...
    vertexCollection = cms.InputTag( "hltOnlineVerticesAfterIter0" ),
...
process.hltIsoMuonVertex = cms.EDProducer( "VertexFromTrackProducer",
    ...
    vertexLabel = cms.InputTag( "hltOnlineVerticesAfterIter0" ),
...
process.hltIsoMuPFTauTagInfoStdVtx = cms.EDProducer( "PFRecoTauTagInfoProducer",
    ...
    GammaCand_EcalclusMinEt = cms.double( 0.5 ),
    tkminPixelHitsn = cms.int32( 0 ),
    PVProducer = cms.InputTag( "hltOnlineVerticesAfterIter0" ),
    PFCandidateProducer = cms.InputTag( "hltParticleFlowForTaus" ),
    ChargedHadrCand_tkminPt = cms.double( 0.0 ),
    ChargedHadrCand_tkmaxipt = cms.double( 0.2 ),
    ChargedHadrCand_tkminPixelHitsn = cms.int32( 0 ),
...
process.hltIsoMuPFTauLooseIsolationDiscriminatorStdVtxNoFilters = cms.EDProducer( "PFRecoTauDiscriminationByIsolation",
    ...
    qualityCuts = cms.PSet( 
      ...
      primaryVertexSrc = cms.InputTag( "hltOnlineVerticesAfterIter0" ),
      pvFindingAlgo = cms.string( "highestPtInEvent" )
    ),
    maximumSumPtCut = cms.double( 6.0 ),
    deltaBetaPUTrackPtCutOverride = cms.double( 0.5 ),
...
process.HLTIterativeTrackingIteration0 = cms.Sequence( process.hltPFJetPixelSeedsFromPixelTracks + process.hltPFJetCkfTrackCandidates + process.hltPFJetCtfWithMaterialTracks + process.hltPFlowTrackSelectionHighPurity + process.hltOnlineVerticesAfterIter0 + process.hltTrackRefsForJetsIter0 + process.hltAntiKT5TrackJetsIter0 + process.hltTrackAndTauJetsIter0 )
...
# process.HLT_IsoMu17_eta2p1_LooseIsoPFTau20_v7           = cms.Path( process.HLTBeginSequence + process.hltL1sMu14erORMu16er + process.hltPreIsoMu17eta2p1LooseIsoPFTau20 + process.hltL1fL1sMu14erORMu16erL1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu14erORMu16erL1f0L2Filtered14Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu14erORMu16erL1f0L2f14QL3Filtered17Q + process.HLTL3muoncaloisorecoSequenceNoBools + process.HLTL3muonisorecoSequence + process.hltL3crIsoL1sMu14erORMu16erL1f0L2f14QL3f17QL3crIsoRhoFiltered0p15 + process.HLTRecoJetSequencePrePF + process.hltTauJet5 + process.HLTPFTriggerSequenceMuTau + process.HLTIsoMuLooseIsoPFTauSequence                   + process.hltTauSequence + process.HLTEndSequence )
process.HLT_IsoMu17_eta2p1_LooseIsoPFTau20_NoFilters_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sMu14erORMu16er + process.hltPreIsoMu17eta2p1LooseIsoPFTau20NoFilters + process.hltL1fL1sMu14erORMu16erL1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu14erORMu16erL1f0L2Filtered14Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu14erORMu16erL1f0L2f14QL3Filtered17Q + process.HLTL3muoncaloisorecoSequenceNoBools + process.HLTL3muonisorecoSequence + process.hltL3crIsoL1sMu14erORMu16erL1f0L2f14QL3f17QL3crIsoRhoFiltered0p15 + process.HLTRecoJetSequencePrePF + process.hltTauJet5 + process.HLTPFTriggerSequenceMuTau + process.HLTIsoMuLooseIsoPFTauSequenceNoFilters + process.hltTauSequence + process.HLTEndSequence )
